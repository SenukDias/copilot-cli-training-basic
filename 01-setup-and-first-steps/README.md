...
![Chapter 01: First Steps](01-setup-and-first-steps/images/chapter-header.png)
...
<img src="01-setup-and-first-steps/images/first-copilot-experience.png" alt="Developer sitting at a desk with code on the monitor and glowing particles representing AI assistance" width="800"/>
...
![Code Review Demo](01-setup-and-first-steps/images/code-review-demo.gif)
...
![Explain Code Demo](01-setup-and-first-steps/images/explain-code-demo.gif)
...
![Generate Code Demo](01-setup-and-first-steps/images/generate-code-demo.gif)
...
<img src="01-setup-and-first-steps/images/modes-and-commands.png" alt="Futuristic control panel with glowing screens, dials, and equalizers representing Copilot CLI modes and commands" width="800"/>
...
<img src="01-setup-and-first-steps/images/ordering-food-analogy.png" alt="Three Ways to Use GitHub Copilot CLI - Plan Mode (GPS route to restaurant), Interactive Mode (talking to waiter), Programmatic Mode (drive-through)" width="800"/>
...
<img src="01-setup-and-first-steps/images/interactive-mode.png" alt="Interactive Mode - Like talking to a waiter who can answer questions and adjust the order" width="250"/>
...
<img src="01-setup-and-first-steps/images/plan-mode.png" alt="Plan Mode - Like planning a route before a trip using GPS" width="250"/>
...
<img src="01-setup-and-first-steps/images/programmatic-mode.png" alt="Programmatic Mode - Like using a drive-through for a quick order" width="250"/>
...
<img src="../01-setup-and-first-steps/images/practice.png" alt="Warm desk setup with monitor showing code, lamp, coffee cup, and headphones ready for hands-on practice" width="800"/>
